...
public class V1PanelFunc03 extends JPanel {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 5919269474254579682L;
	...
	public void setMessageSource(MessageSource messageSource) {
		...
		JLabel label = new JLabel(messageSource.getMessage("menu_admin_basic_setting_mtn", new Object[]{},  locale));
		add(label, "2, 2");
	}
}
